...
struct ParametersConfig
{
	...
	ParametersConfig()
	{
		...
		config1.angle_gain_forward = 1.6;
		...
		config2.angle_gain_forward = 1.1;//0.8
		config2.angle_gain_back = 0.06;
		config2.gas_gain = 1.0;
		config2.base_speed_forward = 0.7;
		...
		config3.angle_gain_forward = 2.33;//2.0
		...
		config4.Lrv = 0.6;
		config4.Vcmd = 0.7;
		config4.Lfw =0.92;//0.95
		config4.lfw = 0.13;
		config4.lrv = 10.0;
		config4.controller_freq = 20.0;
		config4.angle_gain_forward = 3.2;
		config4.angle_gain_back = 1.8;
		config4.gas_gain = 1.6;
		config4.base_speed_forward = 0.65;
		...
		// config4.lrv = 10.0;
		// config4.controller_freq = 20.0;
		// config4.angle_gain_forward = 5.0;
		// config4.angle_gain_back = 1.8;
		// config4.gas_gain = 1.6;
		// config4.base_speed_forward = 0.6;
		// config4.base_speed_back = 0.65;
		// config4.base_angle = 1.0;
		// config4.AllowReverse = false;
		...
		config6.angle_gain_back = 1.05;
		config6.gas_gain = 1.2;
		config6.base_speed_forward = 0.55;
		config6.base_speed_back = 0.6;
		...
		config7.angle_gain_forward = 1.6;
		config7.angle_gain_back = 0.65;
		config7.gas_gain = 1.2;
		config7.base_speed_forward = 0.8;
