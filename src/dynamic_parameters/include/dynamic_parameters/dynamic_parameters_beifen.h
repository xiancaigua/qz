...
struct ParametersConfig
{
	...
	ParametersConfig()
	{
		...
		config1.angle_gain_forward = 1.53;//1.48
		...
		config2.angle_gain_forward = 0.8;//1.3
		config2.angle_gain_back = 0.06;
		config2.gas_gain = 1.0;
		config2.base_speed_forward = 0.7;//0.8
		...
		config3.Lrv = 1.0;
		config3.Vcmd = 0.7;
		config3.Lfw =0.75;//0.7
		config3.lfw = 0.12;
		config3.lrv = 10.0;
		config3.controller_freq = 20.0;
		config3.angle_gain_forward = 2.28;//2.0 2.25
		...
		config4.Lrv = 0.6;
		config4.Vcmd = 0.7;
		config4.Lfw =0.95;//1.0
		config4.lfw = 0.13;
		config4.lrv = 10.0;
		config4.controller_freq = 20.0;
		config4.angle_gain_forward = 3.7;
		config4.angle_gain_back = 1.8;
		config4.gas_gain = 1.6;
		config4.base_speed_forward = 0.61;//0.7
		...
		config5.angle_gain_forward = 3.0;//2.0
		config5.angle_gain_back = 0.65;
		config5.gas_gain = 1.2;
		config5.base_speed_forward = 0.8;//1.2
		...
		config6.angle_gain_back = 0.8;
		config6.gas_gain = 1.2;
		config6.base_speed_forward = 0.55;
		config6.base_speed_back = 0.35;
		...
		config7.angle_gain_forward = 1.35;
